...
// ── Lightbox ──────────────────────────────────────────────────────
const extraImages = computed(() => props.berita?.images ?? []);

const allImages = computed(() => {
    const list: string[] = [];
    if (props.berita?.image) list.push(props.berita.image);
...
<template>
    ...
    <div class="page-root">
        ...
        <section class="cover-section">
            <div class="cover-bg" :style="berita?.image ? { backgroundImage: 'url(' + berita.image + ')' } : {}"></div>
                            ...
                            <div v-if="extraImages.length > 0" class="gallery-section">
                                ...
                                <div class="gallery-grid">
                                    <div
                                        ...
                                        :key="index"
                                        class="gallery-item"
                                        @click="openLightbox(berita.image ? index + 1 : index)"
                                    >
...
.meta-gallery{background:#f0fdf4;color:var(--g700);padding:3px 10px;border-radius:20px;font-weight:600;border:1px solid #bbf7d0}
