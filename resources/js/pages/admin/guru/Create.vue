...
const getAvailableKelasForWali = (taId: string, currentIndex: number) => {
    ...
    return props.kelas.filter(k => !k.existing_wali_tahun_ajaran.includes(id) && !formState.wali_kelas.some((w, i) => i !== currentIndex && w.kelas_id === k.id.toString() && w.tahun_ajaran_id === taId));
};
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900 h-fit">
                            ...
                            <div class="p-6 space-y-4">
                                <div class="flex justify-center">
                                    <img v-if="imagePreview" :src="imagePreview" alt="Preview" class="h-48 w-48 rounded-2xl border border-gray-200 bg-gray-50 object-cover ring-1 ring-black/5 dark:border-gray-700 dark:bg-gray-800 dark:ring-white/10" />
                                ...
                                <button v-if="imagePreview" @click="removeImage" type="button" class="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-red-50 px-4 py-2.5 text-sm font-semibold text-red-700 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40">
