...
const removeStatusTahunAjaran = (index: number) => {
    if (form.status_tahun_ajaran.length > 1) form.status_tahun_ajaran.splice(index, 1);
};

const getAvailableTahunAjaranForStatus = (currentIndex: number) => {
    const usedIds = form.status_tahun_ajaran
                                ...
                                <div class="space-y-8">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div ref="refNama" class="space-y-1.5">
                                            ...
                                            <p v-if="form.errors.nama" class="text-xs text-red-500 dark:text-red-400 flex items-center gap-1"><span v-html="ErrIcon()"></span>{{ form.errors.nama }}</p>
                                        </div>
                                        ...
                                        <div ref="refJabatan" class="space-y-1.5">
                                            ...
                                            <input v-model="form.jabatan" @input="delete localErrors['jabatan']" type="text" placeholder="Contoh: Tata Usaha, Teknisi Lab"
                                            ...
                                            <p v-if="form.errors.jabatan" class="text-xs text-red-500 dark:text-red-400 flex items-center gap-1"><span v-html="ErrIcon()"></span>{{ form.errors.jabatan }}</p>
                                        </div>
                                        ...
                                        <div ref="refJenisKelamin" class="space-y-1.5">
                                            ...
                                            <p v-if="form.errors.jenis_kelamin" class="text-xs text-red-500 dark:text-red-400 flex items-center gap-1"><span v-html="ErrIcon()"></span>{{ form.errors.jenis_kelamin }}</p>
                                        </div>
                                    </div>
