...
// Mode input jenis: 'dropdown' | 'manual'
// Jika jenisList kosong, langsung manual
const inputMode = ref<'dropdown' | 'manual'>(props.jenisList.length > 0 ? 'dropdown' : 'manual');

// Saat pilih dari dropdown → set form.jenis
const onDropdownChange = (e: Event) => {
    const val = (e.target as HTMLSelectElement).value;
    if (val === '__manual__') {
        // User ingin ketik sendiri
        form.jenis   = '';
...
const handleSubmit = () => {
    form.post(route('admin.organisasi.store'), {
        preserveScroll: true,
        forceFormData: true,
    });
};
                ...
                <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <!-- Mode: manual (ketik bebas) -->
                            <div v-else class="space-y-2">
                                <div class="flex gap-2">
                                    <input v-model="form.jenis" type="text"
                                        placeholder="Ketik jenis organisasi baru..."
                                        :class="form.errors.jenis ? 'ring-red-400 focus:ring-red-500' : 'ring-gray-200 focus:ring-blue-600'"
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Ketik jenis baru yang belum ada di daftar</p>
                            </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input id="logo-input" type="file" accept="image/jpeg,image/png,image/jpg,image/svg+xml"
