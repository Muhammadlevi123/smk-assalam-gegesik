...
interface Props { tahunAjaran: TahunAjaran[]; guru: Guru[]; }
...
const onTahunChange = (index: number) => {
    const p = formState.pengajaran[index];
    // Reset guru jika guru yang dipilih tidak tersedia di tahun ajaran baru
...
// Guru boleh mengampu lebih dari satu mata pelajaran, jadi tidak ada filter
                        ...
                        <div class="space-y-8">
                            ...
                            <div ref="refNama" class="space-y-1.5 max-w-sm">
                                ...
                                <input v-model="formState.nama" @input="delete localErrors['nama']" type="text"
                                    placeholder="Contoh: Matematika, Pemrograman Web, Kimia"
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Contoh: Matematika, Pemrograman Web, Bahasa Indonesia</p>
